...
const Page: React.FC = () => {
  ...
  return (
    <div className="space-y-28">
       <BannerComponent  
         logoSRC="https://i.ibb.co.com/hZQS2ZH/minutes.jpg"
        logoLabel="Minutes"
        headingLabel="Focus on engaging, not note-taking"
       ...
       bannerImageSRC="https://i.ibb.co.com/89c4H92/minutebanner.jpg"
  />

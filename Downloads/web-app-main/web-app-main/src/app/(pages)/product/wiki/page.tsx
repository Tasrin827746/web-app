...
const Page: React.FC = () => {
  ...
  return (
    <div className="space-y-28">
        <BannerComponent  
         logoSRC="https://i.ibb.co.com/vQTrcZn/m-Ru-FNIyra-FZRVq-HNSd1gf-P4izg.jpg"
        logoLabel="Wiki"
        headingLabel=" A single source of truth for organizational knowledge"
        headingDescriptionLabel="A knowledge management solution for organizations, where you can create, organize and manage rich content with your entire team."
        hrefText="/signup"
        linkLabel="Try for free"
       bannerImageSRC="https://i.ibb.co.com/KFrGRfb/wikibanner.jpg"
  />

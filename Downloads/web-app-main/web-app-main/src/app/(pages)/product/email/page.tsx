...
import emailFAQ from "../../../../../public/data/emailFAQ.json";
import AllApps from '@/app/components/Product/Email/AllApps';
import Migration from '@/app/components/Product/Email/Migration';
...
const Page: React.FC = () => {
  const items: FAQItem[] = emailFAQ.items;
  ...
  return (
    <div className="space-y-28">
       <BannerComponent  
         logoSRC="https://i.ibb.co.com/CMxL9Vm/maill.jpg"
        logoLabel="Email"
        headingLabel="Get Lark Mail for free"
       ...
       bannerImageSRC="https://i.ibb.co.com/rpJYV6y/emailbanner.jpg"
  />

...
import Card from "./FakeData/GolablCard.json";
import Logo from "./FakeData/Logo.json";
...
const Global = () => {
  ...
  useEffect(() => {
    setTestimonials((Card.testimonials || []) as Testimonial[]);
    setLogos((Logo.logos || []) as LogoType[]);
  }, []);

  return (
    <div className="bg-gradient-to-b from-white to-violet-100 py-12">
      ...
      >
        ...
        <div className="px-10 grid grid-cols-1 cursor-pointer mt-16 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              <div className="flex items-center mb-4 pb-4 border-b border-gray-200">
                <img
                  src={testimonial.image || "/default-profile.jpg"}
              ...
              <div className="mt-4 flex items-center justify-between">
                ...
                <div>
                  <img
                    src={testimonial.logo || "/default-logo.jpg"}

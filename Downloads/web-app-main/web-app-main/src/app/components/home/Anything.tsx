    ...
    >
      ...
      <header className="text-center mb-10 mt-10">
        ...
        >
          ...
          employees are. Use it on your phone or desk. <br /> Lark is for everyone and every
          role. Collaborate with cross-border colleagues without missing the point. Automate
          workflows to enhance efficiency.
        </motion.p>
        <motion.button
          onClick={() => router.push("/auth/sign-up")}
          className="text-xl bg-gradientLinear text-white px-4 mt-4 py-2 h-12 w-44 rounded-full shadow-lg font-semibold hover:hover-bg-gradientLinear transition sm:w-40"
      ...
      <main className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
        {/* Base Card */}
        <motion.div
          onClick={() => router.push("/pages/product/base")}
          ...
          style={{
            backgroundImage:
              "url('https://i.ibb.co/RzxK22H/uit-Gm-CA62-TN966-Zbm-Yi-Dt16y6ng.jpg')",
          }}
        ...
        {/* Messenger Card */}
        <motion.div
          onClick={() => router.push("/pages/product/messenger")}
          ...
          style={{
            backgroundImage:
              "url('https://i.ibb.co/9btPk0X/Hqt-AGv-Qfpkx-Zqx8-Nqo-Wn-Syf3aa0.jpg')",
          }}
          initial={{ opacity: 0, scale: 0.9 }}
          whileInView={{ opacity: 1, scale: 1 }}
          whileHover={{ scale: 1.05 }}
        ...
        {/* Approval Card */}
        <motion.div
          onClick={() => router.push("/pages/product/approval")}
          ...
          style={{
            backgroundImage:
              "url('https://i.ibb.co/R7sq5Km/Uvh53moo-GSs-Hy-Lu-Vrev-RGIJIi-Ao.jpg')",
          }}
          initial={{ opacity: 0, scale: 0.9 }}
          whileInView={{ opacity: 1, scale: 1 }}
          whileHover={{ scale: 1.05 }}

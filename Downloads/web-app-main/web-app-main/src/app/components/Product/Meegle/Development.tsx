...
// Define the topic type structure
type Topic = {
  heading: string;
  description: string;
  image: string;
...
export default function Development() {
  ...
  const { description, image, color, link } = topics[selectedTopic];

  return (
    <div className="min-h-96 bg-gradient-to-b from-purple-50 to-white flex flex-col items-center p-6">
      {/* Header */}
      <div className="text-center mb-6">
        ...
        <h1 className="text-3xl font-bold text-gray-800 mb-6 mt-6">We&apos;ve Got You Covered!</h1>
        <HeadingDescriptionComponent
          headingDescriptionLabel={"Check out Meegle’s solution! Boost efficiency and achieve optimal performance."}
        />
      </div>
